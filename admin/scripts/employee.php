...
function addContent($content)
{
    try {
        ...
        $insert_content_query = 'INSERT INTO tbl_employees(name, position, email, image';
        $insert_content_query .= ' VALUES(:name, :position, :email, :image)';
        ...
        // if (!empty($last_updated_id) && $insert_content_result) {
